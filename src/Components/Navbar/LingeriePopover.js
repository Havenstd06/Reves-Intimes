...
export default function LingeriePopover() {
    return (
        <Popover className="z-0 relative w-full">
            {({ open }) => (
                <>
                    <div className="relative z-10">
                        <div className="max-w-7xl mx-auto flex">
                            <Popover.Button
                                className="py-1 px-4 text-blueGray-600 text-sm focus:outline-none transition duration-200 ease-in-out no-underline border-b border-white hover:border-blueGray-600 flex"
                            >
                                <span>Lingerie</span>
                                <ChevronDownIcon
